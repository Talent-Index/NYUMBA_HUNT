      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-primary">Nyumba Hunt</span>
          </Link>
        </div>
        ...
        <Card className="shadow-elevated border-0">
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground">
              Join Nyumba Hunt and find your perfect home
            </p>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-6">
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="tenant">House Hunter (Tenant)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="landlord" id="landlord" />
                    <Label htmlFor="landlord">Property Owner</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label
                  ...
                  className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                >
                  Send me property alerts and updates
                </Label>
              </div>
